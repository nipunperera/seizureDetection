close all
clear
%% Wavelet Packet Transform based Seizure Detection
...
% % Perform wavelet packet decomposition on a sliding window and acquire
% % features
% 
% 
% % [u, v, w] = wpspectrum(wpt, 256, 'plot');
% 
% % Creating the feature vector
% wdSize = 1024;      % Window size
...
%                 featVec = [featVec ; log(sqrt(mean(wpCoef.*wpCoef)))];
%             end
%         end
%         featMat = [featVec featMat];
%     end
% end
% 
% % Indices corresponding to seizure events 
